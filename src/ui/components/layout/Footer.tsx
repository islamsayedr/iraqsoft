...
import { IraqsIcon, IraqsLogo } from "../common/atoms/IraqsLogo";
import {
  EmailLink,
  Exteranl,
  LocationLink,
  NavLink,
  PhoneLink,
} from "../common/atoms/Links";
import { FacebookRate, GoogleRate } from "../common/molecules/StarRate";
const bgart = "./imgs/bgart02.png";
import Subscribe from "../common/molecules/Subscribe";
import { Facebook, Github, Telegram, Youtube } from "../../../assets/icons";
